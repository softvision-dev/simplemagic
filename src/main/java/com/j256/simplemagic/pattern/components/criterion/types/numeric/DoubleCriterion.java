...
/**
 * Represents a Double criterion from a line in magic (5) format.
 * <p>
 ...
 * @author graywatson
 */
public class DoubleCriterion extends AbstractNumberCriterion {
	...
	protected Number applyAddition(Number extractedValue, Number operand) {
		return extractedValue.doubleValue() + operand.doubleValue();
	}
	...
	protected boolean testEqual(Number extractedValue) {
		return getTestValue() != null && extractedValue != null &&
				extractedValue.doubleValue() == getTestValue().doubleValue();
	}
