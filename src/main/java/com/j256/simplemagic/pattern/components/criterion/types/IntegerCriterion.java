...
/**
 * Represents an Integer criterion from a line in magic (5) format.
 * <p>
 * A four-byte integer often handled the "long" types when the spec was written.
 * </p>
 *
 * @author graywatson
 */
public class IntegerCriterion extends AbstractNumberCriterion {
