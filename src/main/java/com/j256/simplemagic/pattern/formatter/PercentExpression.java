...
/**
 * Representation of our percent expression used by the {@link AbstractMagicFormatter} class.
 * 
 * @author graywatson
 */
public class PercentExpression {
	...
	private final static Pattern FORMAT_PATTERN = Pattern.compile("%([0#+ -]*)([0-9]*)(\\.([0-9]+))?(["
			+ AbstractMagicFormatter.PATTERN_MODIFIERS + "]*)([" + AbstractMagicFormatter.FINAL_PATTERN_CHARS + "])");
	...
	/**
	 * Package permissions because the {@link AbstractMagicFormatter} should only be constructing it.
	 */
