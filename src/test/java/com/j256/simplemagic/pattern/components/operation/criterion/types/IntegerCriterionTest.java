...
public class IntegerCriterionTest extends BaseMagicTypeTest {
	...
	public void testLittleEndianNumber() throws MagicPatternException, IOException {
		...
		assertEquals(MatchingState.FULL_MATCH, pattern.isMatch(hexToBytes("c5c6cb03"), 0, new MagicEntries()).getMatchingState());
	}
	...
	public void testBigEndianNumber() throws MagicPatternException, IOException {
		...
		assertEquals(MatchingState.FULL_MATCH, pattern.isMatch(hexToBytes("03c7b3a1"), 0, new MagicEntries()).getMatchingState());
	}
